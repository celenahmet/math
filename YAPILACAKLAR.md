...
- [ ] **Ahmet:** yazı sonu metinleri varsayılan: "Evet/Hayır", "Neyi eksik buldun?", "Henüz yorum yok.", form notu, `js/etkilesim.js` başındaki `METIN` (sınır, hata, gönderildi). İfade seti 26.09'da Ahmet'in seçimiyle değişti: ❤️ Sevdim, 🔥 Harika, ✅ Anladım (💡 çıktı), 🤯, 🤔, 😅 (`api/_ifadeler.json`). Canlıda sayı birikmeden değişti; bundan sonra anahtar değişirse o ifadenin sayısı kaybolur. Hub'daki "Bu seçimde henüz yazı yok." de varsayılan.
