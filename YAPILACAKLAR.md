...
- [ ] 06-50 BEKLİYOR (Ahmet 24.09: "6-50 arası bekleyecek sonra ekleriz"); sıradaki: 86 Oran ve Orantı Problemleri (kapaklar 86-100 hazır). 25.09: 81-85 yayında (kesir, yaş, yüzde, kâr-zarar, faiz problemleri; 13640 denetim). Not: `matematik.py` \quad / \qquad tanımıyor; sympy `solveset(|x-2| > -1)` yanlışlıkla boş küme veriyor (tümleyenle denetle)
